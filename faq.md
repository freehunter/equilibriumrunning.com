...
- Running frequently
- Building toward a long run
- Including some faster running when possible
- Gradually increasing specificity as race day approaches
...
- The plan provides structure
- E-Running provides methodology

You can use any plan you like and apply E-Running as the decision-making layer on top. That might mean:
- Swapping hard days when life intervenes
- Turning a workout into an easy run
- Skipping a session without trying to “make it up”
- Extending a phase because your body needs more time
...
- Easy runs make up the majority of mileage
- Faster runs happen when you’re rested enough to absorb them
- Speed is the first thing removed when stress rises, and the last thing added back
...
- How stress or sleep affected it
- What gear, fuel, or pace worked
- Emotional shifts that came up
...
Yup. 5K, 10K, 10M, 13.1, full marathon. See some examples [here](./examples.md).